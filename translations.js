...
const I18N = {
    ru: {
        ...
        settings_title: '⚙️ Настройки каталога', set_category: 'Категория', set_sort: '↕️ Сортировка', set_perpage: '📊 Отображать на странице', set_reset: 'Сбросить конфигурацию',
    ...
    ua: {
        ...
        settings_title: '⚙️ Налаштування каталогу', set_category: 'Категорія', set_sort: '↕️ Сортування', set_perpage: '📊 Відображати на сторінці', set_reset: 'Скинути конфігурацію',
    ...
    en: {
        ...
        settings_title: '⚙️ Catalog settings', set_category: 'Category', set_sort: '↕️ Sort by', set_perpage: '📊 Per page', set_reset: 'Reset configuration',
    ...
    es: {
        ...
        settings_title: '⚙️ Ajustes del catálogo', set_category: 'Categoría', set_sort: '↕️ Ordenar', set_perpage: '📊 Por página', set_reset: 'Restablecer configuración',
    ...
    zh: {
        ...
        settings_title: '⚙️ 目录设置', set_category: '分类', set_sort: '↕️ 排序', set_perpage: '📊 每页显示', set_reset: '重置配置',
