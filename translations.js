...
const I18N = {
    ru: {
        ...
        cat_all: 'Все', cat_social: 'Соц.сети', cat_music: 'Музыка', cat_video: 'Видео', cat_design: 'Дизайн', cat_network: 'VPN', cat_russia: 'Россия',
        cat_study: 'Учёба', cat_office: 'Офис', cat_games: 'Игры', cat_kids: 'Дети', cat_life: 'Здоровье', cat_money: 'Финансы', cat_travel: 'Путешествия', cat_themes: 'Темы', cat_other: 'Другое',
    ...
    ua: {
        ...
        cat_all: 'Усі', cat_social: 'Соц.мережі', cat_music: 'Музика', cat_video: 'Відео', cat_design: 'Дизайн', cat_network: 'VPN', cat_russia: 'Росія',
        cat_study: 'Навчання', cat_office: 'Офіс', cat_games: 'Ігри', cat_kids: 'Діти', cat_life: 'Здоров\'я', cat_money: 'Фінанси', cat_travel: 'Подорожі', cat_themes: 'Теми', cat_other: 'Інше',
    ...
    en: {
        ...
        cat_all: 'All', cat_social: 'Social', cat_music: 'Music', cat_video: 'Video', cat_design: 'Design', cat_network: 'VPN', cat_russia: 'Russia',
        cat_study: 'Study', cat_office: 'Office', cat_games: 'Games', cat_kids: 'Kids', cat_life: 'Health', cat_money: 'Finance', cat_travel: 'Travel', cat_themes: 'Themes', cat_other: 'Other',
    ...
    es: {
        ...
        cat_all: 'Todos', cat_social: 'Social', cat_music: 'Música', cat_video: 'Vídeo', cat_design: 'Diseño', cat_network: 'VPN', cat_russia: 'Rusia',
        cat_study: 'Estudio', cat_office: 'Oficina', cat_games: 'Juegos', cat_kids: 'Niños', cat_life: 'Salud', cat_money: 'Finanzas', cat_travel: 'Viajes', cat_themes: 'Temas', cat_other: 'Otros',
    ...
    zh: {
        ...
        cat_all: '全部', cat_social: '社交', cat_music: '音乐', cat_video: '视频', cat_design: '设计', cat_network: 'VPN', cat_russia: '俄罗斯',
        cat_study: '学习', cat_office: '办公', cat_games: '游戏', cat_kids: '儿童', cat_life: '健康', cat_money: '金融', cat_travel: '旅行', cat_themes: '主题', cat_other: '其他',
